if (window.__retrogradePlayerInit) {
} else {
  window.__retrogradePlayerInit = true;

  var RETROGRADE_TRACKS = [
    { artist: 'MACHINE GIRL', title: 'BLACK GLASS',            src: 'https://file.garden/aBb6prPw8QkQxICV/music/blackglass.wav' },
    { artist: 'STEVE MILLER BAND', title: 'FLY LIKE AN EAGLE',    src: 'https://file.garden/aBb6prPw8QkQxICV/music/flylikeaneagel.wav' },
  ];
